...
public class Client {
    private static final String USAGE = "java banking.Client <bank_url>";
            ...
            switch (userInputTokenNo) {
                case 1:
                    try {
                        ...
                        System.out.println("Illegal command. Error - " + ex.getMessage());
                        return null;
                    }
                    break;
                case 2:
                ...
                case 3:
                    try {
                        ...
                        System.out.println("Illegal amount. Error - " + ex.getMessage());
                        return null;
                    }
                    break;
                default:
    ...
    void execute(Command command) throws RemoteException, RejectedException {
        ...
        switch (command.getCommandName()) {
            ...
            case withdraw:
                ...
                break;
            case balance:
                System.out.println("balance: SEK " + account.getBalance());
                break;
            default:
                System.out.println("Illegal command");
        }
